...
var DEFAULT_HISTORY_URL =
  "https://uk.investing.com/instruments/HistoricalDataAjax";
...
program
  ...
  .option(
    "-f --file [file]",
    "result file. If none, the result will be printed to the console."
  )
...
function bodyToCSV(body) {
  ...
  if (verbose) console.log("Found " + (csv.length - 1) + " records.");
